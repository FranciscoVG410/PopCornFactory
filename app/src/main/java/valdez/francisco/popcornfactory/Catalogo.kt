...
class Catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas(){
        ...
        peliculas.add(Pelicula("1917", R.drawable.a1970, R.drawable.header1970, "British trenches somewhere in France. World war has been going on for the third year,\n" +
